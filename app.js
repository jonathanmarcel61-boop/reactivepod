...
const pantallaPods =
    document.getElementById("pantallaPods");
 
const pantallaPerfiles =
    document.getElementById("pantallaPerfiles");
 
const pantallaTiposEntrenamiento =
    document.getElementById("pantallaTiposEntrenamiento");
...
const nombrePerfilInicio =
    document.getElementById("nombrePerfilInicio");
 
const inicioMejorTiempo =
    document.getElementById("inicioMejorTiempo");
 
const inicioPrecision =
    document.getElementById("inicioPrecision");
 
const inicioSesiones =
    document.getElementById("inicioSesiones");
 
const inicioRacha =
    document.getElementById("inicioRacha");
 
const btnPerfiles =
    document.getElementById("btnPerfiles");
 
const btnGestionarPods =
    document.getElementById("btnGestionarPods");
...
const indicadorPods =
    document.getElementById("indicadorPods");
 
const textoEstadoPods =
    document.getElementById("textoEstadoPods");
...
const cantidadPodsConectados =
    document.getElementById(
        "cantidadPodsConectados"
    );
 
const btnApagarTodos =
    document.getElementById(
        "btnApagarTodos"
    );
 
const btnVolverDesdePods =
    document.getElementById(
        "btnVolverDesdePods"
    );
...
const btnNuevoPerfil =
    document.getElementById(
        "btnNuevoPerfil"
    );
 
const btnVolverPerfiles =
    document.getElementById(
        "btnVolverPerfiles"
    );
...
const nombrePerfilTipos =
    document.getElementById(
        "nombrePerfilTipos"
    );
 
const btnVolverTipos =
    document.getElementById(
        "btnVolverTipos"
    );
...
const nombrePerfilConfiguracion =
    document.getElementById(
        "nombrePerfilConfiguracion"
    );
...
const pausaEntreRondas =
    document.getElementById(
        "pausaEntreRondas"
    );
 
const contenedorEspera =
    document.getElementById(
        "contenedorEspera"
    );
 
const contenedorPausa =
    document.getElementById(
        "contenedorPausa"
    );
 
const sonidosActivados =
    document.getElementById(
        "sonidosActivados"
    );
 
const podsListosConfiguracion =
    document.getElementById(
        "podsListosConfiguracion"
    );
...
const btnVolverEntrenamientos =
    document.getElementById(
        "btnVolverEntrenamientos"
    );
...
const nombreModoActivo =
    document.getElementById(
        "nombreModoActivo"
    );
 
const nombrePerfilEntrenamiento =
    document.getElementById(
        "nombrePerfilEntrenamiento"
    );
...
function obtenerGuiaModoV7() {
    ...
    const guias = {
        simple: {
            ...
            descripcion: "Un Pod se iluminará de forma aleatoria. Tu objetivo es reaccionar rápido y tocar únicamente el Pod activo.",
            pasos: [
        ...
        colores: {
            ...
            descripcion: "Los cuatro Pods muestran colores distintos. La pantalla te indicará qué color debes buscar y tocar.",
            pasos: [
        ...
        secuencia: {
            ...
            descripcion: "Los Pods mostrarán una secuencia. Memorízala y luego repítela exactamente en el mismo orden.",
            pasos: [
        ...
        doble: {
            ...
            descripcion: "Dos Pods se encenderán al mismo tiempo. Debes encontrar y tocar ambos para completar la ronda.",
            pasos: [
        ...
        prohibido: {
            ...
            descripcion: "Todos los Pods se iluminan, pero existe un color que NO debes tocar. Elige cualquiera de los otros tres.",
            pasos: [
        ...
        circuito: {
            ...
            descripcion: "Completa los cuatro Pods en un orden aleatorio. Cada Pod aparece una sola vez dentro de cada circuito.",
            pasos: [
        ...
        persecucion: {
            icono: "🔥",
            titulo: "Persecución",
            descripcion: "Persigue el objetivo de un Pod a otro. Cada acierto activa inmediatamente un nuevo Pod y el color puede cambiar en cada estímulo.",
            pasos: [
        ...
        entrenador: {
            ...
            descripcion: "El entrenador decide qué Pod activar desde el teléfono. Cada Pod conserva el color fijo configurado para esta sesión.",
            pasos: [
        ...
        libre: {
            icono: "🏃",
            titulo: "Modo libre",
            descripcion: "Toca cualquiera de los cuatro Pods libremente. La app registrará tu ritmo y los intervalos entre golpes.",
            pasos: [
...
const nombrePerfilResultados =
    document.getElementById(
        "nombrePerfilResultados"
    );
 
const resultadoRondas =
    document.getElementById(
        "resultadoRondas"
    );
...
const btnNuevoEntrenamiento =
    document.getElementById(
        "btnNuevoEntrenamiento"
    );
 
const btnResultadosInicio =
    document.getElementById(
        "btnResultadosInicio"
    );
...
const nombrePerfilProgreso =
    document.getElementById(
        "nombrePerfilProgreso"
    );
 
const progresoMejorTiempo =
    document.getElementById(
        "progresoMejorTiempo"
    );
...
const rellenoObjetivo =
    document.getElementById(
        "rellenoObjetivo"
    );
 
const textoObjetivoProgreso =
    document.getElementById(
        "textoObjetivoProgreso"
    );
 
const graficoProgreso =
    document.getElementById(
        "graficoProgreso"
    );
...
const btnEditarObjetivo =
    document.getElementById(
        "btnEditarObjetivo"
    );
 
const btnVolverProgreso =
    document.getElementById(
        "btnVolverProgreso"
    );
...
const nombrePerfilEstadisticas =
    document.getElementById(
        "nombrePerfilEstadisticas"
    );
...
const btnEstadisticasInicio =
    document.getElementById(
        "btnEstadisticasInicio"
    );
...
let duracionSecuenciaMs =
    600;
 
let intervaloSecuenciaMs =
    250;
 
let objetivoCorrecto =
    -1;
 
let objetivosDobles =
    [];
 
let objetivosDoblesPendientes =
    new Set();
 
let indiceColorProhibido =
    -1;
 
let circuitoOrden =
    [];
 
let circuitoPosicion =
    0;
 
let circuitoTiempoInicio =
    0;
 
// Modo contrarreloj
let duracionContrarrelojSeg =
    30;
 
let finContrarrelojMs =
    0;
 
let objetivoContrarreloj =
    -1;
 
let temporizadorFinContrarreloj =
    null;
 
let intervaloContrarreloj =
    null;
...
let posicionSecuencia =
    0;
 
let indiceMostrarSecuencia =
    0;
 
let ultimoGolpeLibre =
    0;
...
async function conectarPodNativo(
    indice
) {
    ...
    try {
        ...
        if (
            ...
            throw new Error(
                "No se obtuvo el identificador BLE."
            );
        }
        ...
        await prepararNotificacionesPod(
            indice
        );
        ...
        console.log(
            `✅ ${pod.nombre} conectado manualmente`
        );
        ...
        console.error(
            `Error conectando ${pod.nombre}:`,
            error
        );
 
 
        marcarPodNoConectado(
            indice,
            "No conectado"
        );
        ...
        alert(
            `No se pudo conectar ${pod.nombre}.`
        );
    }
}
...
async function conectarPodWeb(
    ...
    if (
        ...
        alert(
            "Web Bluetooth no está disponible. Usa Chrome o Edge."
        );
...
async function podDesconectado(
    indice
) {
...
async function limpiarListenersPod(
    pod
) {
 
    if (
        pod.notificationListener
    ) {
...
async function prepararNotificacionesPod(
    indice
) {
    ...
    if (
        ...
        throw new Error(
            `No existe deviceId para ${pod.nombre}`
        );
    }
 
 
    const claveNotificacion =
        `notification|${pod.deviceId}|${SERVICE_UUID}|${BUTTON_UUID}`;
...
async function conectarPodEncontrado(
    indice,
    dispositivo
) {
    ...
    try {
        ...
        console.log(
            `✅ ${pod.nombre} reconectado automaticamente`
        );
        ...
        console.error(
            `No se pudo reconectar ${pod.nombre}:`,
            error
        );
...
function actualizarEstadoGeneralPods() {
    ...
    textoEstadoPods.textContent =
        `${cantidad} de 4`;
 
 
    cantidadPodsConectados.textContent =
        `${cantidad} / 4`;
 
 
    podsListosConfiguracion.textContent =
        `${cantidad} / 4`;
...
async function enviarComandoPod(
    indice,
    comando
) {
...
function recibirBotonFisicoNativo(
    indice,
    evento
) {
...
function recibirBotonFisicoWeb(
    indice,
    evento
) {
...
function cargarAjustes() {
    ...
    ajusteSonidos.checked =
        ajustesApp.sonidos;
 
 
    sonidosActivados.checked =
        ajustesApp.sonidos;
}
...
function obtenerPerfilActivo() {
    ...
    return datosApp.perfiles
        .find(
 
            perfil =>
                perfil.id ===
                datosApp.perfilActivoId
...
function actualizarFotoPerfilInicio() {
    ...
    if (
        ...
        if (
            nombrePerfilInicio &&
            nombrePerfilInicio.parentElement
        ) {
...
function crearPerfil() {
    ...
    if (
        ...
        alert(
            "Ya existe un deportista con ese nombre."
        );
...
function eliminarPerfil(
    ...
    if (
        !confirm(
            "¿Eliminar este deportista y todo su historial?"
        )
    ) {
...
function actualizarResumenInicio() {
    ...
    const resumen =
        calcularResumenPerfil();
 
 
    inicioMejorTiempo.textContent =
        resumen.mejorTiempo === null
            ?
            "-- s"
            :
            `${resumen.mejorTiempo.toFixed(3)} s`;
 
 
    inicioPrecision.textContent =
        `${resumen.precision.toFixed(1)} %`;
 
 
    inicioSesiones.textContent =
        resumen.sesiones;
 
 
    inicioRacha.textContent =
        resumen.racha;
}
...
function obtenerColorAleatorioParaPod(indice, excluidos = []) {
    ...
    if (!disponibles.length) {
        disponibles = CLAVES_COLORES_REACTIPOD.filter(
            clave => !bloqueados.has(clave)
        );
    }
 
    const clave = disponibles[
...
function aplicarDificultadSeleccionada() {
    ...
    if (
        ...
        dificultadActual === "personalizada"
    ) {
 
        const espera =
            esperaAleatoria.value
                .split(",")
                .map(Number);
 
        esperaMinima = espera[0];
        esperaMaxima = espera[1];
        pausaRondasMs = Number(
            pausaEntreRondas.value
        );
...
function actualizarResumenDificultad() {
    ...
    const descripciones = {
        facil: "Fácil · El Pod tarda más en aparecer: espera aprox. 2–4 s y hay más pausa entre estímulos. Ideal para aprender el ejercicio.",
        media: "Media · Ritmo equilibrado: espera aprox. 1–3 s y pausas moderadas. Recomendado para entrenamiento normal.",
        dificil: "Difícil · El estímulo aparece mucho más rápido: espera aprox. 0.5–1.5 s y pausas cortas. Exige reacción y concentración.",
        personalizada: "Personal · Tú eliges manualmente la espera antes del estímulo y la pausa entre rondas cuando el modo lo permite."
    };
...
function crearControlesExperienciaEntrenamiento() {
    ...
    panel.innerHTML = `
        ...
        <div
            ...
            style="display:none;margin-bottom:18px;padding:14px;border-radius:14px;background:#0f172a;border:1px solid #334155;"
        >
            <div style="font-size:15px;font-weight:800;margin-bottom:8px;">⏱ Duración del desafío</div>
            <select id="duracionContrarrelojReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
        ...
        >
            ...
            <select id="tipoFinalGeneralReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
                <option value="rondas" selected>Número de rondas</option>
                <option value="tiempo">Tiempo</option>
            </select>
 
            <div id="controlRondasGeneralReactiPod" style="margin-top:12px;">
                <label style="display:block;font-size:12px;color:#9ca3af;margin-bottom:6px;">Rondas</label>
                <select id="rondasGeneralReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
            ...
            <div id="controlTiempoGeneralReactiPod" style="display:none;margin-top:12px;">
                <label style="display:block;font-size:12px;color:#9ca3af;margin-bottom:6px;">Duración</label>
                <select id="duracionGeneralReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
                    <option value="15">15 segundos</option>
        ...
        >
            <div style="font-size:15px;font-weight:800;margin-bottom:10px;">🧑‍🏫 Finalizar entrenamiento por</div>
            <select id="tipoFinalEntrenadorReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
                <option value="rondas" selected>Número de rondas</option>
                <option value="tiempo">Tiempo</option>
            </select>
            ...
            <div id="controlRondasEntrenadorReactiPod" style="margin-top:12px;">
                <label style="display:block;font-size:12px;color:#9ca3af;margin-bottom:6px;">Rondas</label>
                <select id="rondasEntrenadorReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
            ...
            <div id="controlTiempoEntrenadorReactiPod" style="display:none;margin-top:12px;">
                <label style="display:block;font-size:12px;color:#9ca3af;margin-bottom:6px;">Duración</label>
                <select id="duracionEntrenadorReactiPod" style="width:100%;padding:11px;border-radius:11px;border:1px solid #334155;background:#111827;color:#fff;font-weight:700;">
                    <option value="30">30 segundos</option>
                    <option value="60" selected>60 segundos</option>
                    <option value="90">90 segundos</option>
                    <option value="120">2 minutos</option>
        ...
        <div id="panelColoresFijosReactiPod" style="display:none;">
            ...
            <button
                ...
                style="margin-top:12px;width:100%;padding:11px;border-radius:12px;border:1px solid #334155;background:#172033;color:#fff;font-weight:700;"
            >
        ...
        <div id="bloqueDificultadReactiPod" style="margin-top:18px;padding-top:18px;border-top:1px solid rgba(148,163,184,.18);">
            ...
            <div
                ...
                style="font-size:13px;color:#aeb9c9;line-height:1.5;margin-bottom:2px;"
            ></div>
        </div>
    `;
    ...
    const referencia =
        btnComenzar.parentElement ||
        pantallaConfiguracion;
 
 
    if (
        referencia === pantallaConfiguracion
    ) {
    ...
    const bloqueInicio = obtenerBloqueDirectoDePantallaV12(btnComenzar, pantallaConfiguracion);
...
function pintarControlesExperiencia() {
        ...
        .forEach(
            boton => {
                ...
                boton.classList.toggle(
                    "activa",
                    boton.dataset.dificultad === dificultadActual
                );
            }
        );
    ...
    if (selectorTipoGeneral && controlRondasGeneral && controlTiempoGeneral) {
        controlRondasGeneral.style.display = selectorTipoGeneral.value === "rondas" ? "block" : "none";
        controlTiempoGeneral.style.display = selectorTipoGeneral.value === "tiempo" ? "block" : "none";
    }
 
    const selectorTipoEntrenador = document.getElementById("tipoFinalEntrenadorReactiPod");
    const controlRondasEntrenador = document.getElementById("controlRondasEntrenadorReactiPod");
    const controlTiempoEntrenador = document.getElementById("controlTiempoEntrenadorReactiPod");
    if (selectorTipoEntrenador && controlRondasEntrenador && controlTiempoEntrenador) {
        controlRondasEntrenador.style.display = selectorTipoEntrenador.value === "rondas" ? "block" : "none";
        controlTiempoEntrenador.style.display = selectorTipoEntrenador.value === "tiempo" ? "block" : "none";
    }
...
function localizarContenedorRondasBaseV12() {
    ...
    while (nodo && nodo !== pantallaConfiguracion) {
        ...
        const contieneRondas = texto.includes("número de rondas") || texto.includes("numero de rondas");
        const contieneOtrosCampos = texto.includes("sonidos") || texto.includes("pods disponibles");
...
function crearTarjetaPersecucion() {
    ...
    const tarjeta =
        primeraTarjeta.cloneNode(true);
 
 
    tarjeta.dataset.modo =
        "persecucion";
    ...
    primeraTarjeta.parentElement.appendChild(
        tarjeta
    );
}
...
function configurarModo() {
    ...
    if (controlContrarreloj) {
        controlContrarreloj.style.display =
            modoActual === "contrarreloj" ? "block" : "none";
    }
    ...
    if (
        ...
        contenedorEspera.style.display =
            "none";
...
function iniciarEntrenamiento() {
    ...
    if (
        ...
        alert(
            "Debes conectar los 4 Pods antes de iniciar."
        );
    ...
    estadoEntrenamiento.textContent =
        "ACTIVO";
...
function iniciarTemporizadorGeneralSiAplica() {
    ...
    if (!entrenamientoActivo || tipoFinalGeneral !== "tiempo" || ["entrenador", "contrarreloj"].includes(modoActual)) {
        return;
    }
...
async function iniciarRonda() {
    ...
    if (tipoFinalGeneral !== "tiempo" || ["entrenador", "contrarreloj"].includes(modoActual)) {
    ...
    colorObjetivo.style.background =
        "#374151";
...
async function activarColores() {
    ...
    coloresActuales =
        obtenerColoresAleatoriosUnicosPods();
...
async function activarDobleEstimulo() {
    ...
    const colorSegundo =
        obtenerColorEstimulo(
            segundo,
            [colorPrimero.comando]
        );
 
 
    colorObjetivo.style.background =
        `linear-gradient(135deg, ${colorPrimero.css} 0 48%, ${colorSegundo.css} 52% 100%)`;
...
async function respuestaDobleEstimulo(
    indice
) {
    ...
    objetivosDoblesPendientes.delete(
        indice
    );
    ...
    if (
        objetivosDoblesPendientes.size > 0
    ) {
 
        mensajeResultado.textContent =
            "✅ Primero correcto · falta uno";
 
        mensajeResultado.className =
            "mensajeResultado mensajeCorrecto";
    ...
    mensajeResultado.textContent =
        `✅ DOBLE COMPLETADO · ${tiempo.toFixed(3)} s`;
...
async function respuestaColorProhibido(
    indice
) {
    ...
    if (
        ...
        mensajeResultado.textContent =
            `✅ Evitaste ${coloresActuales[indiceColorProhibido].nombre}`;
...
async function mostrarObjetivoCircuito() {
    ...
    nombreColor.textContent =
        `${color.nombre} · ${circuitoPosicion + 1}/4`;
...
async function respuestaCircuito(
    indice
) {
    ...
    if (
        ...
        mensajeResultado.textContent =
            `❌ Pod ${indice + 1} incorrecto · busca Pod ${esperado + 1}`;
    ...
    mensajeResultado.textContent =
        `✅ CIRCUITO COMPLETO · ${tiempo.toFixed(3)} s`;
...
async function activarPersecucion() {
    ...
    if (
        objetivoCorrecto >= 0 &&
        nuevoObjetivo === objetivoCorrecto
    ) {
        nuevoObjetivo =
            (
                nuevoObjetivo +
...
async function respuestaPersecucion(
    indice
) {
    ...
    textoRonda.textContent =
        `Objetivo ${aciertos + 1} de ${totalRondasActual}`;
...
async function iniciarContrarreloj() {
    ...
    temporizadorFinContrarreloj = setTimeout(terminarContrarreloj, duracionContrarrelojSeg * 1000);
...
async function respuestaContrarreloj(indice) {
    ...
    resultados.push({
        ...
        correcto,
        tiempo,
        estado: correcto ? `Pod ${objetivoContrarreloj + 1} correcto` : `Pod ${indice + 1}; objetivo Pod ${objetivoContrarreloj + 1}`
    });
...
function crearPanelEntrenadorActivo() {
    ...
    panel.innerHTML = `
        <div style="font-size:13px;color:#94a3b8;margin-bottom:10px;">CONTROL DEL ENTRENADOR</div>
    ...
    // V12: el control del entrenador debe estar arriba y al alcance del pulgar,
    // antes del objetivo central y de los controles de pausa/cancelación.
    const referenciaSuperior =
        obtenerBloqueDirectoDePantallaV12(estadoEntrenamiento, pantallaEntrenamiento) ||
        obtenerBloqueDirectoDePantallaV12(textoRonda, pantallaEntrenamiento) ||
        obtenerBloqueDirectoDePantallaV12(colorObjetivo, pantallaEntrenamiento);
 
    if (referenciaSuperior) {
        pantallaEntrenamiento.insertBefore(panel, referenciaSuperior);
...
function mostrarPanelEntrenadorActivo(mostrar) {
    const panel = mostrar ? crearPanelEntrenadorActivo() : document.getElementById("panelEntrenadorActivoReactiPod");
...
async function iniciarEntrenador() {
    ...
    if (tipoFinalEntrenador === "tiempo") {
        ...
        temporizadorFinEntrenador = setTimeout(terminarEntrenadorTiempo, duracionEntrenadorSeg * 1000);
    } else {
...
function actualizarTiempoEntrenador() {
    if (!entrenamientoActivo || modoActual !== "entrenador" || tipoFinalEntrenador !== "tiempo") return;
    const restante = Math.max(0, (finEntrenadorMs - performance.now()) / 1000);
    textoRonda.textContent = `Tiempo restante: ${restante.toFixed(1)} s`;
}
 
async function activarPodEntrenador(indice) {
    if (!entrenamientoActivo || modoActual !== "entrenador" || esperandoRespuesta || pausado) return;
...
async function respuestaNormal(
    indice
) {
...
async function respuestaSecuencia(
    indice
) {
    ...
    if (
        ...
        resultados.push({
            ...
            estado:
                `Secuencia incorrecta - Pod ${indice + 1}`
 
        });
 
 
        // NUEVO: todos los Pods se ponen rojos cuando hay un error.
        await feedbackTodosPods(
            "red",
            "#ef4444",
            800
        );
    ...
    if (
        ...
        mensajeResultado.textContent =
            `✅ Paso ${posicionSecuencia} correcto`;
...
async function iniciarLibre() {
    ...
    textoRonda.textContent = tipoFinalGeneral === "tiempo"
...
async function golpeLibre(
    ...
    iluminarPodPresionado(
        indice,
        220
    ).catch(error => console.warn("Feedback de Modo libre omitido:", error));
    ...
    mensajeResultado.textContent =
        `✅ Pod ${indice + 1} - ${tiempo.toFixed(3)} s`;
...
async function iluminarPodPresionado(
    indice,
    duracion =
        300
) {
...
async function feedbackTodosPods(
    comando,
    colorCSS,
    duracion = 800
) {
...
async function apagarTodosLosPodsConLimiteV13(limiteMs = 700) {
    try {
        ...
        console.warn("ReactiPod V13: apagado BLE omitido para no bloquear la interfaz.", error);
    }
    apagarVisuales();
}
...
function mostrarResultados() {
    ...
    nombrePerfilResultados.textContent =
        perfil.nombre;
 
 
    resultadoRondas.textContent =
        resultados.length;
...
function mostrarEstadisticas() {
    ...
    nombrePerfilEstadisticas.textContent =
        perfil.nombre;
    ...
    promedioGeneral.textContent =
        ...
        null
            ...
            "-- s"
            :
            `${resumen.promedio.toFixed(3)} s`;
 
 
    mejorPromedio.textContent =
        resumen.mejorPromedio ===
        null
            ?
            "-- s"
            :
            `${resumen.mejorPromedio.toFixed(3)} s`;
    ...
    totalErrores.textContent =
        resumen.errores;
 
 
    precisionGeneral.textContent =
        `${resumen.precision.toFixed(1)} %`;
                    ...
                    <div>
                        ...
                        <div class="historialDato">
                            ...
                            ${
                                ...
                                "number"
                                    ?
                                    entrenamiento.promedio.toFixed(3) +
                                    " s"
                                    :
                                    "--"
                            }
...
function mostrarProgreso() {
    ...
    nombrePerfilProgreso.textContent =
        perfil.nombre;
    ...
    progresoPrecision.textContent =
        `${resumen.precision.toFixed(1)} %`;
 
 
    progresoRacha.textContent =
        resumen.racha;
...
function actualizarObjetivo() {
    ...
    if (
        ...
        objetivoActual.textContent =
            "-- s";
 
 
        rellenoObjetivo.style.width =
            "0%";
    ...
    textoObjetivoProgreso.textContent =
        `Te faltan ${faltan.toFixed(3)} s para alcanzar tu objetivo.`;
}
...
function dibujarGrafico() {
    ...
    graficoProgreso.width =
        ancho *
        escala;
 
 
    graficoProgreso.height =
        alto *
        escala;
...
function analizarProgreso(
    ...
    if (
        ...
        mensajeProgreso.textContent =
            `📈 Mejoraste ${diferencia.toFixed(3)} s respecto al entrenamiento anterior.`;
        ...
        mensajeProgreso.textContent =
            `El último promedio fue ${Math.abs(diferencia).toFixed(3)} s más lento. La tendencia puede variar entre sesiones.`;
    }
}
...
btnBorrarHistorial.onclick =
    () => {
        ...
        if (
            confirm(
                `¿Borrar todo el historial de ${perfil.nombre}?`
            )
        ) {
...
function organizarModosPorCategoriaV8() {
    ...
    const categorias = [
        { clave:"velocidad", icono:"⚡", titulo:"Velocidad", subtitulo:"Reacción rápida y ritmo continuo", descripcion:"Entrenamientos para responder más rápido ante estímulos visuales.", modos:["simple","persecucion","contrarreloj"] },
        { clave:"coordinacion", icono:"🎯", titulo:"Coordinación", subtitulo:"Precisión y respuesta múltiple", descripcion:"Combina movimiento, precisión y control de varios estímulos.", modos:["colores","doble","circuito"] },
        { clave:"memoria", icono:"🧠", titulo:"Memoria", subtitulo:"Atención y procesamiento", descripcion:"Ejercicios para recordar secuencias y responder con precisión.", modos:["secuencia"] },
        { clave:"control", icono:"🛡️", titulo:"Control", subtitulo:"Decisión, inhibición y control manual", descripcion:"Entrena la toma de decisiones e incluye el modo de control directo para entrenadores.", modos:["prohibido","libre","entrenador"] }
    ];
    ...
    function mostrarCategoriasV9() {
        ...
        if (encabezado) {
            ...
            encabezado.querySelector("p").textContent = "Selecciona una categoría para descubrir los ejercicios disponibles.";
        }
    }
    ...
    document.getElementById("btnVolverCategoriasV9").addEventListener("click", mostrarCategoriasV9);
        ...
        if (typeof pantallaEntrenamiento.animate === "function") {
            pantallaEntrenamiento.animate(
                esCorrecto
                    ? [
                        { filter:"brightness(1)" },
                        { filter:"brightness(1.10)", offset:.45 },
                        { filter:"brightness(1)" }
                    ]
                    : [
                        { transform:"translateX(0)" },
...
function obtenerRecordPersonalV8(perfil, nombreModo, mejorActual) {
    const historialMismoModo = (perfil.historial || [])
        .filter(ent => ent && ent.modo === nombreModo);
    ...
    const recordActual = recordPrevio === null
        ? mejorActual
        : Math.min(recordPrevio, mejorActual);
...
function construirResumenResultadosV8(datos) {
    ...
    const promedioTexto = typeof datos.promedio === "number"
        ? `${datos.promedio.toFixed(3)} s`
        : "--";
...
function ordenarConfiguracionV15() {
    ...
    const cabecera = bloqueDirectoConfiguracionV15(
        tituloConfiguracion || nombrePerfilConfiguracion || btnVolverEntrenamientos
    );
    const descripcion = bloqueDirectoConfiguracionV15(descripcionModo);
    const panel = bloqueDirectoConfiguracionV15(
        document.getElementById('panelExperienciaReactiPod')
    );
    const bloqueSonidos = bloqueDirectoConfiguracionV15(sonidosActivados);
    const bloquePods = bloqueDirectoConfiguracionV15(podsListosConfiguracion);
    const bloqueInicio = bloqueDirectoConfiguracionV15(btnComenzar);
 
    if (!cabecera) return;
 
    // La cabecera del modo siempre queda arriba de todo.
    if (pantallaConfiguracion.firstElementChild !== cabecera) {
        pantallaConfiguracion.insertBefore(cabecera, pantallaConfiguracion.firstElementChild);
    }
 
    let cursor = cabecera;
    const orden = [descripcion, panel, bloqueSonidos, bloquePods, bloqueInicio];
    const usados = new Set([cabecera]);
 
    for (const bloque of orden) {
        if (!bloque || usados.has(bloque)) continue;
        usados.add(bloque);
        cursor = insertarDespuesV15(cursor, bloque) || cursor;
    }
 
    // Ajustes visuales para que el flujo se lea como una sola pantalla.
    cabecera.style.setProperty('margin-top', '0', 'important');
    if (descripcion && descripcion !== cabecera) {
        descripcion.style.setProperty('margin-top', '10px', 'important');
        descripcion.style.setProperty('margin-bottom', '16px', 'important');
    }
    if (panel) {
...
configurarModo = function() {
    ...
    requestAnimationFrame(ordenarConfiguracionV15);
};
...
function ordenarEntrenadorActivoV15() {
    ...
    const bloqueObjetivo = obtenerBloqueDirectoDePantallaV12(
        nombreColor || colorObjetivo || textoObjetivo,
        pantallaEntrenamiento
    );
 
    if (bloqueObjetivo && panel.parentElement === pantallaEntrenamiento) {
        bloqueObjetivo.insertAdjacentElement('afterend', panel);
    }
...
mostrarPanelEntrenadorActivo = function(mostrar) {
    ...
    if (mostrar) {
        ...
        requestAnimationFrame(ordenarEntrenadorActivoV15);
    }
};
